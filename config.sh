...
#export GRAFANA_CLOUD_INSTANCE_KEY=$(cat ../.grafana/GRAFANA_CLOUD_INSTANCE_KEY.txt)
...
# you can pick a password here, or have it an external file such as ../.grafana/GRAFANA_LOCAL_ADMIN_PASS.txt
...
# you can pick a InfluxDB password here, or have it in an external file, e.g. ../.influx/INFLUXDB_LOCAL_ADMIN_PASSWORD.txt
...
INFLUXDBCHART="4.10.3"             # see https://artifacthub.io/packages/helm/influxdata/influxdb
INGRESSNGINXCHART="4.0.13"         # see https://artifacthub.io/packages/helm/ingress-nginx/ingress-nginx
FLUENTBITCHART="0.19.17"           # see https://artifacthub.io/packages/helm/fluent/fluent-bit
...
KEDACHART="2.5.1"                  # see https://artifacthub.io/packages/helm/kedacore/keda
KUBERNETESDASHBOARDCHART="5.1.1"   # see https://artifacthub.io/packages/helm/k8s-dashboard/kubernetes-dashboard
NGINXCHART="9.7.3"                 # see https://artifacthub.io/packages/helm/bitnami/nginx
